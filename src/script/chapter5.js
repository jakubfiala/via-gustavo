...
export const changeOfMind = [
  ...
  { duration: 1 },
  { text: "I saw you climbing that hill, and I thought" },
  { text: "maybe this one isn't just a voyeur?" },
  ...
  { text: "The Atacama is vast, but her people know to stick to the right path." },
