...
export const poem = [
  ...
  { text: "to point three parallel lines towards your destination." },
  { duration: 1 },
  { text: "Gustavo! Who are they?" },
  { text: "Those who keep pulling over in the evening" },
  { text: "weeping or staring solemnly, leaving mark after mark at the place" },
  { text: "where your last breath joined the Atacama air." },
  { text: "Your offspring, friends or lovers," },
  { text: "I sense their broken hearts when their feet touch the asphalt." },
  { duration: 1 },
  { text: "Dear Gustavo," },
  { text: "The sun is burning brighter than ever" },
  ...
  { text: "I lead them to your sanctuary" },
  { text: "to stand still for a while, my dear Gustavo," },
  { text: "right here on my crumbling shoulder," },
  { text: "no sound of rustling bushes, no smell of burned rubber," },
  { text: "and honour you." },
  { duration: 1 },
  { text: "Oh Gustavo!" },
  { text: "Ages may pass, the winds of time, may blow away your memory," },
  { text: "but today, it travels across the planet" },
  { text: "today, it's etched in semiconductors" },
  { text: "in Quilicura, Canelones," },
  { text: "in Douglas County, Inzai and Hanau." },
