...
export const station1 = [
  ...
  { text: "When you're ready... see that street at the back of the church?" },
...
export const station2 = [
  ...
  { text: "He slams the truck door shut. The ignition roars." },
  { duration: 3 },
...
export const station4 = [
  ...
  { text: "The seatbelt wraps around his body. The tongue slides, effortless and final, into the buckle." },
...
export const station5 = [
  ...
  { text: "That probably makes him think of his mother, so he pulls out his phone and starts a voice note." },
  { text: "This time, he really lets it all out." },
  { text: "It feels so good that, when he's done, he fires up another one to his brothers," },
  { text: "grandad," },
  { text: "auntie." },
...
export const station10 = [
  ...
  { text: "There are people in the desert whom he cannot see, and yet they are present." },
...
export const station14 = [
  ...
  { text: "I watched him cross many lanes of the highway intersection and follow the dirt road on the other side." },
  { duration: 0.75 },
  { text: "And now I have to admit something... please don't be mad at me!" },
  { text: "We've now reached my frontier. I can't come with you any further." },
  { duration: 1 },
  { text: "Oh god, I feel so bad making you come all this way, but I really had no choice." },
  { text: "Would you go forth and find my dear friend?" },
  { text: "Would you tell him he's missed? That there's still a place for him back home?" },
  { text: "Perhaps he'll change his mind... perhaps one day we'll be reunited." },
  { text: "How far, how long you must go, I cannot say, but I am beyond certain," },
