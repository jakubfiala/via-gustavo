...
export default (context) => {
  ...
  return {
    ...
    viaCrucis4: createScorePart(context, 'assets/audio/score/via-crucis-4.mp3', false, 0.4),
    viaCrucis5: createScorePart(context, 'assets/audio/score/via-crucis-5.mp3', false, 0.4),
    viaCrucis6: createScorePart(context, 'assets/audio/score/via-crucis-6.mp3', false, 0.4),
    viaCrucis7: createScorePart(context, 'assets/audio/score/via-crucis-7.mp3', false, 0.4),
    ...
    circuito1: createScorePart(context, 'assets/audio/score/circuito-sketch-1.mp3', false, 0.4),
    circuito2: createScorePart(context, 'assets/audio/score/circuito-sketch-2.mp3', false, 0.4),
    circuito3: createScorePart(context, 'assets/audio/score/circuito-sketch-3.mp3', false, 0.3),
