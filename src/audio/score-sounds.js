...
export default (context) => {
  ...
  return {
    ...
    viaCrucis5: createScorePart(context, 'assets/audio/score/via-crucis-5.mp3', false, 0.45),
    viaCrucis6: createScorePart(context, 'assets/audio/score/via-crucis-6.mp3', false, 0.45),
    viaCrucis7: createScorePart(context, 'assets/audio/score/via-crucis-7.mp3', false, 0.45),
